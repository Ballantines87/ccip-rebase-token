...
contract RebaseTokenPool is TokenPool {
    ...
    function lockOrBurn(
        ...
        // we finally need to return Pool.LockOrBurnOutV1 struct - because we're sending the message CROSS-CHAIN here
    ...
    function releaseOrMint(
        ...
        // and so we're mint(...)ing the tokens on this chain when we are receiving a cross-chain transfer to this chain to the receiver
